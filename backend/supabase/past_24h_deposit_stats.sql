-- ════════════════════════════════════════════════════════════════════════════════
-- PAST 24 HOURS DEPOSIT STATS FOR PROMOTION VIEW
...
BEGIN
  ...
  -- Recursively get all team members (2+ levels down)
...
-- FUNCTION 3: Get Invited Members with real deposit data for AgentManagement
