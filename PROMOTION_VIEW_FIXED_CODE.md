// UPDATE FOR PromotionView.tsx - Replace fetchStats function
...
const fetchStats = async () => {
  ...
  try {
    console.log('[PromotionView] Fetching stats for uid:', uid);
    ...
    if (directError) {
      console.error('[PromotionView] Direct invites error:', directError);
      throw directError;
    }
    ...
    console.log('[PromotionView] Direct invites data:', directData);
    ...
    if (teamError) {
      console.error('[PromotionView] Team invites error:', teamError);
      throw teamError;
    }
    ...
    console.log('[PromotionView] Team invites data:', teamData);
    ...
    console.log('[PromotionView] Direct members:', directMembers?.length || 0);
    console.log('[PromotionView] Team members:', teamCount);
